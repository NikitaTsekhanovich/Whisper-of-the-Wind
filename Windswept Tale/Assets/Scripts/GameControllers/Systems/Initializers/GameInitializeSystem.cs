...
namespace GameControllers.Systems.Initializers
{
    public class GameInitializeSystem : IEcsInitSystem
    {
        ...
        private void InitGameData()
        {
            ...
            _gameData.SpawnLocationPostionX = _gameData.WidthCanvas + _gameData.WidthCanvas * 4;
            _gameData.BorderDestroyPositionX = 0 - (_gameData.MainCanvasRectTransform.rect.width + _gameData.WidthCanvas * 4);
        }
